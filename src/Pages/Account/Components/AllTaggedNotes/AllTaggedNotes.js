...
function AllTaggedNotes() {
    ...
    const [allNotes, loading, setUrl] = useNotes(`https://note-taking-server.netlify.app/.netlify/functions/app/get-notes/tags:${tags}`);
    ...
    useEffect(() => {
        setUrl(`https://note-taking-server.netlify.app/.netlify/functions/app/get-notes/tags:${tags}`);
    }, [tags])
