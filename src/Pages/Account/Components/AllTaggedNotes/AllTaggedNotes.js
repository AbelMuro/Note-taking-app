...
function AllTaggedNotes() {
    ...
    const [allNotes, loading, setUrl] = useNotes(`https://note-taking-server-thr9.onrender.com/get-notes/tags:${tags}`);
    ...
    useEffect(() => {
        setUrl(`https://note-taking-server-thr9.onrender.com/get-notes/tags:${tags}`);
    }, [tags])
